 ...
 *     John Rodriguez
 *     Retarget to Lua.
 *     Breakpoint commands sent to ldb which runs the Lua interpreter
 *     Changed breakpoints to be 1 based which agrees with Lua editor
******************************************************************************/
...
public class PDALineBreakpoint extends LineBreakpoint implements IPDAEventListener {
    ...
    protected void createRequest(PDADebugTarget target) throws CoreException {
    	target.sendRequest("break " + getLineNumber());
    }
    ...
    /**
     * Notify's the Lua interpreter that this breakpoint has been hit.
     */
